...
# python 3.7. Regular variables (COMPONENT_VERSION, COMPONENT_SRC, ...) refer
...
# Support for different component versions in 3.7 and newer 3.x variants.
ifneq ($(COMPONENT_VERSION_OLD),)

SOURCE_DIR_OLD = $(COMPONENT_DIR)/$(COMPONENT_SRC_OLD)
$(BUILD_DIR)/%-3.7/.built: SOURCE_DIR=$(SOURCE_DIR_OLD)
$(BUILD_DIR)/%-3.7/.installed: SOURCE_DIR=$(SOURCE_DIR_OLD)
$(BUILD_DIR)/%-3.7/.tested: SOURCE_DIR=$(SOURCE_DIR_OLD)
$(BUILD_DIR)/%-3.7/.tested-and-compared: SOURCE_DIR=$(SOURCE_DIR_OLD)
$(BUILD_DIR)/%-3.7/.system-tested: SOURCE_DIR=$(SOURCE_DIR_OLD)
$(BUILD_DIR)/%-3.7/.system-tested-and-compared: SOURCE_DIR=$(SOURCE_DIR_OLD)
...
$(MANIFEST_BASE)-%-37.mangled: COMPONENT_SRC=$(COMPONENT_SRC_OLD)
$(MANIFEST_BASE)-%-37.depend: COMPONENT_SRC=$(COMPONENT_SRC_OLD)
$(MANIFEST_BASE)-%-37.published: COMPONENT_SRC=$(COMPONENT_SRC_OLD)
...
NEW_ONLY =
OLD_ONLY = \#
$(MANIFEST_BASE)-%-37.mogrified: NEW_ONLY = \#
$(MANIFEST_BASE)-%-37.mogrified: OLD_ONLY =
