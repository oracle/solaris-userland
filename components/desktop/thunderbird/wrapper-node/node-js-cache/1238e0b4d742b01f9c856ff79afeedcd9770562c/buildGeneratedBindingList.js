    ...
    for (const name of Object.keys(generated.bindings)) {
      ...
      for (const loc of refs) {
        if (bindings) {
          ...
          const globalGrip = (_globalScope = globalScope) === null || _globalScope === void 0 ? void 0 : _globalScope.object;
...
function buildFakeBindingList(generatedAstScopes) {
    ...
    for (const name of Object.keys(generated.bindings)) {
      ...
      for (const loc of refs) {
        acc.push({
          name,
          loc,
          desc: () => Promise.resolve((0, _optimizedOut.getOptimizedOutGrip)())
        });
      }
    }
