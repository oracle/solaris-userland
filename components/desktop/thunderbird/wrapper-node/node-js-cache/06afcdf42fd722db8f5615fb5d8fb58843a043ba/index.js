...
class Editor extends _react.PureComponent {
  ...
  openMenu(event) {
    ...
    if (target.classList.contains("CodeMirror-linenumber")) {
      ...
      return (0, _menu.showMenu)(event, [...(0, _breakpoints.createBreakpointItems)(cx, location, breakpointActions, lineText), {
        type: "separator"
  ...
  setText(props, editor) {
    ...
    return (0, _editor2.showSourceText)(editor, selectedSource, selectedSourceTextContent, symbols);
  }
