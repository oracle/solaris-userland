...
const initialUIState = () => ({
  ...
  javascriptTracingLogMethod: _prefs.prefs.javascriptTracingLogMethod,
  javascriptTracingValues: _prefs.prefs.javascriptTracingValues,
  javascriptTracingOnNextInteraction: _prefs.prefs.javascriptTracingOnNextInteraction,
  javascriptTracingOnNextLoad: _prefs.prefs.javascriptTracingOnNextLoad,
  javascriptTracingFunctionReturn: _prefs.prefs.javascriptTracingFunctionReturn,
...
function update(state = initialUIState(), action) {
  switch (action.type) {
    ...
    case "TOGGLE_TRACING":
      {
        if (action.status === "start") {
          return { ...state,
            javascriptTracingEnabled: action.enabled
          };
        }
    ...
    case "SET_JAVASCRIPT_TRACING_LOG_METHOD":
      {
        _prefs.prefs.javascriptTracingLogMethod = action.value;
        return { ...state,
          javascriptTracingLogMethod: action.value
        };
      }

    case "TOGGLE_JAVASCRIPT_TRACING_VALUES":
      {
        _prefs.prefs.javascriptTracingValues = !_prefs.prefs.javascriptTracingValues;
        return { ...state,
          javascriptTracingValues: _prefs.prefs.javascriptTracingValues
        };
      }
    ...
    case "TOGGLE_JAVASCRIPT_TRACING_ON_NEXT_INTERACTION":
      {
        _prefs.prefs.javascriptTracingOnNextInteraction = !_prefs.prefs.javascriptTracingOnNextInteraction;
        return { ...state,
          javascriptTracingOnNextInteraction: _prefs.prefs.javascriptTracingOnNextInteraction
        };
      }
    ...
    case "TOGGLE_JAVASCRIPT_TRACING_ON_NEXT_LOAD":
      {
        _prefs.prefs.javascriptTracingOnNextLoad = !_prefs.prefs.javascriptTracingOnNextLoad;
        return { ...state,
          javascriptTracingOnNextLoad: _prefs.prefs.javascriptTracingOnNextLoad
        };
      }
    ...
    case "TOGGLE_JAVASCRIPT_TRACING_FUNCTION_RETURN":
      {
        _prefs.prefs.javascriptTracingFunctionReturn = !_prefs.prefs.javascriptTracingFunctionReturn;
        return { ...state,
          javascriptTracingFunctionReturn: _prefs.prefs.javascriptTracingFunctionReturn
        };
      }
