...
class ProjectSearch extends _react.Component {
  constructor(props) {
    ...
    _defineProperty(this, "selectMatchItem", async matchItem => {
      ...
      this.props.doSearchForHighlight(this.state.query, (0, _index2.getEditor)(), matchItem.location.line, matchItem.location.column);
    });
  ...
  static get propTypes() {
    return {
      ...
      results: _reactPropTypes.default.array.isRequired,
      ...
      status: _reactPropTypes.default.oneOf(["INITIAL", "FETCHING", "CANCELED", "DONE", "ERROR"]).isRequired,
      modifiers: _reactPropTypes.default.object,
      toggleProjectSearchModifier: _reactPropTypes.default.func
    };
  }
