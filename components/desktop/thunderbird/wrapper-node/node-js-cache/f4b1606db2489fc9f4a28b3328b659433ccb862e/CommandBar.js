...
class CommandBar extends _react.Component {
  ...
  static get propTypes() {
    return {
      ...
      toggleTracing: _reactPropTypes.default.func.isRequired,
      logMethod: _reactPropTypes.default.string.isRequired,
      logValues: _reactPropTypes.default.bool.isRequired,
      traceOnNextInteraction: _reactPropTypes.default.bool.isRequired,
      setJavascriptTracingLogMethod: _reactPropTypes.default.func.isRequired,
  ...
  renderTraceButton() {
    ...
    const isActive = this.props.isTracingEnabled; // But it will only be active once the tracer actually started.
...
const mapStateToProps = state => ({
  ...
  isTracingEnabled: (0, _index.getIsJavascriptTracingEnabled)(state, (0, _index.getCurrentThread)(state)),
  isTracingActive: (0, _index.getIsThreadCurrentlyTracing)(state, (0, _index.getCurrentThread)(state)),
  logMethod: (0, _index.getJavascriptTracingLogMethod)(state),
  logValues: (0, _index.getJavascriptTracingValues)(state),
  traceOnNextInteraction: (0, _index.getJavascriptTracingOnNextInteraction)(state),
  traceOnNextLoad: (0, _index.getJavascriptTracingOnNextLoad)(state),
  traceFunctionReturn: (0, _index.getJavascriptTracingFunctionReturn)(state)
});

var _default = (0, _reactRedux.connect)(mapStateToProps, {
  toggleTracing: _index2.default.toggleTracing,
  setJavascriptTracingLogMethod: _index2.default.setJavascriptTracingLogMethod,
  toggleJavascriptTracingValues: _index2.default.toggleJavascriptTracingValues,
  toggleJavascriptTracingOnNextInteraction: _index2.default.toggleJavascriptTracingOnNextInteraction,
  toggleJavascriptTracingOnNextLoad: _index2.default.toggleJavascriptTracingOnNextLoad,
  toggleJavascriptTracingFunctionReturn: _index2.default.toggleJavascriptTracingFunctionReturn,
