...
var _index3 = require("devtools/client/shared/components/reps/index");
...
const mapStateToProps = state => {
  ...
  const selectedFrame = (0, _index2.getSelectedFrame)(state, (0, _index2.getCurrentThread)(state));
