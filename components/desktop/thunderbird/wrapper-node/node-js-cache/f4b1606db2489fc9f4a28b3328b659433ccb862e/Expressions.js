...
class Expressions extends _react.Component {
  ...
  renderNewExpressionInput() {
    ...
    return (0, _reactDomFactories.form)({
      className: classnames("expression-input-container expression-input-form", {
        focused
      }),
...
const mapStateToProps = state => {
  const selectedFrame = (0, _index3.getSelectedFrame)(state, (0, _index3.getCurrentThread)(state));
