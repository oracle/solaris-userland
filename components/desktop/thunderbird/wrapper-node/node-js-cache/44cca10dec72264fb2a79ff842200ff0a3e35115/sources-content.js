...
function updateSourceTextContent(state, action) {
  ...
  if (action.sourceId) {
    state.mutableOriginalSourceTextContentMapBySourceId.set(action.sourceId, content);
  }

  if (action.sourceActorId) {
    state.mutableGeneratedSourceTextContentMapBySourceActorId.set(action.sourceActorId, content);
  }
