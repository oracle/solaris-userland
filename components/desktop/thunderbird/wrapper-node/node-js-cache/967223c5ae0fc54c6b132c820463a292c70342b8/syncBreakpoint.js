...
function syncPendingBreakpoint(cx, sourceId, pendingBreakpoint) {
  return async thunkArgs => {
    ...
    if (source == generatedSource && isPendingBreakpointWithSourceMap) {
      ...
      const breakpointServerLocation = (0, _breakpoint.makeBreakpointServerLocation)(getState(), sourceGeneratedLocation);
      return dispatch((0, _.addBreakpoint)(cx, sourceGeneratedLocation, pendingBreakpoint.options, pendingBreakpoint.disabled, () => !client.hasBreakpoint(breakpointServerLocation)));
    }
