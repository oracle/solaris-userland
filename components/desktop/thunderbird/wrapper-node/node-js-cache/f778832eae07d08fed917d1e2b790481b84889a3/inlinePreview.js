...
function generateInlinePreview(selectedFrame) {
  return async function ({
    ...
    if ((0, _index.getInlinePreviews)(getState(), selectedFrame.thread, selectedFrame.id)) {
      return null;
    }

    const originalFrameScopes = (0, _index.getOriginalFrameScope)(getState(), selectedFrame);
    const generatedFrameScopes = (0, _index.getGeneratedFrameScope)(getState(), selectedFrame);
