  ...
  disableEmptyLines() {
    ...
    codeMirror.operation(() => {
      ...
      for (let i = 0; i < lineCount; i++) {
        const line = (0, _index2.fromEditorLine)(selectedSource.id, i, isSourceWasm);
...
const mapStateToProps = state => {
  ...
  const breakableLines = (0, _index.getSelectedBreakableLines)(state);
  return {
    selectedSource,
    breakableLines
  };
...
var _default = (0, _reactRedux.connect)(mapStateToProps)(EmptyLines);
