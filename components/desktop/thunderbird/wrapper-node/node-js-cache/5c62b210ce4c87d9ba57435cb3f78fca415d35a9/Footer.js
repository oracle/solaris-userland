...
class SourceFooter extends _react.PureComponent {
  ...
  static get propTypes() {
    return {
      ...
      prettyPrintMessage: _reactPropTypes.default.string.isRequired,
      ...
      isSelectedSourceBlackBoxed: _reactPropTypes.default.bool.isRequired,
...
const mapStateToProps = state => {
  ...
  const isSourceActorWithSourceMapProp = (0, _index2.isSourceActorWithSourceMap)(state, selectedLocation?.sourceActor.id);
