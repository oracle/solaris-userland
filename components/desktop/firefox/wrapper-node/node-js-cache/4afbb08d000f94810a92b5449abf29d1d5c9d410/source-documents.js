...
exports.clearDocumentsForSources = clearDocumentsForSources;
...
function clearDocumentsForSources(sources) {
...
function resetLineNumberFormat(editor) {
  ...
  (0, _ui.resizeToggleButton)((0, _ui.getLineNumberWidth)(cm));
}
