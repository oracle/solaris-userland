...
exports.toggleJavascriptTracingValues = toggleJavascriptTracingValues;
exports.toggleJavascriptTracingOnNextInteraction = toggleJavascriptTracingOnNextInteraction;
exports.toggleJavascriptTracingFunctionReturn = toggleJavascriptTracingFunctionReturn;
exports.toggleJavascriptTracingOnNextLoad = toggleJavascriptTracingOnNextLoad;
...
function toggleJavascriptTracingValues() {
  return {
    type: "TOGGLE_JAVASCRIPT_TRACING_VALUES"
  };
}

function toggleJavascriptTracingOnNextInteraction() {
  return {
    type: "TOGGLE_JAVASCRIPT_TRACING_ON_NEXT_INTERACTION"
  };
}

function toggleJavascriptTracingFunctionReturn() {
  return {
    type: "TOGGLE_JAVASCRIPT_TRACING_FUNCTION_RETURN"
  };
}

function toggleJavascriptTracingOnNextLoad() {
  return {
