...
function paused(pauseInfo) {
  return async function ({
    ...
    if (selectedFrame) {
      ...
      (0, _context.validateSelectedFrame)(getState(), selectedFrame); // Fetch the previews for variables visible in the currently selected paused stackframe

      await dispatch((0, _fetchScopes.fetchScopes)(selectedFrame)); // Run after fetching scoping data so that it may make use of the sourcemap
